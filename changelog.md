...
## Unreleased
- Add GitHub Actions CI to run lint/tests/build, build the multi-stage production Docker image, and publish a downloadable OCI image artifact (no Nginx; Node serves `dist/`).
